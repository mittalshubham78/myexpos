load --os $HOME/Downloads/myexpos/spl/spl_progs/os_startup13.xsm
load --idle $HOME/Downloads/myexpos/expl/expl_progs/idle.xsm
load --library $HOME/Downloads/myexpos/expl/library.lib
load --int=timer $HOME/Downloads/myexpos/spl/spl_progs/timer_14.xsm
load --int=7 $HOME/Downloads/myexpos/spl/spl_progs/INT_7.xsm
load --int=10 $HOME/Downloads/myexpos/spl/spl_progs/exit.xsm
load --int=11 $HOME/Downloads/myexpos/spl/spl_progs/INT_11.xsm
load --int=15 $HOME/Downloads/myexpos/spl/spl_progs/INT_15.xsm
load --int=13 $HOME/Downloads/myexpos/spl/spl_progs/INT_13.xsm
...
load --module 1 $HOME/Downloads/myexpos/spl/spl_progs/MOD_1.xsm
load --module 2 $HOME/Downloads/myexpos/spl/spl_progs/MOD_2.xsm
load --int=6 $HOME/Downloads/myexpos/spl/spl_progs/INT_6.xsm
load --int=9 $HOME/Downloads/myexpos/spl/spl_progs/INT_9.xsm
